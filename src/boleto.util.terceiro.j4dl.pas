unit boleto.util.terceiro.j4dl;
...
type
  ...
  public
    ...
    function IsJsonVazil(const S: String): Boolean;
...
function TJsonBase.IsJsonVazil(const S: String): Boolean;
begin
  if not IsJsonObject(S) then
    raise Exception.Create('nao é um objeto json válido');
